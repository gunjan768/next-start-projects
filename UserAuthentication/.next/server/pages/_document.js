...
class MyDocument extends next_document__WEBPACK_IMPORTED_MODULE_1___default.a {
  static async getInitialProps(context) {
    const props = await next_document__WEBPACK_IMPORTED_MODULE_1___default.a.getInitialProps(context);
    const userData = await Object(_lib_auth__WEBPACK_IMPORTED_MODULE_2__["getServerSideToken"])(context.req);
